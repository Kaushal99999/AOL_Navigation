...
function calculateDistance(lat1, lng1, lat2, lng2) {
  ...
  function findNearestCoordinate(currentLat, currentLng, coordinateRoute) {
    let minDistance = Infinity;
    let nearestLat = null;
    let nearestLng = null;
  
    for (const coordinate of coordinateRoute) {
  ...
  module.exports = findNearestCoordinate;
